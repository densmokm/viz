...
| 15 Balance Sheet Carve-Out | [How to carve a division out of a group ledger](https://claude.ai/code/artifact/d0efaada-1055-480d-84a0-ec3d4cd00b96) | Reciprocal allocation by matrix inversion; conserving the pool; disclosed corporate bases; benchmarked standalone cost; driving the balance sheet off the segmented P&L |
